...
function RightPedalObject( gamephysics , world , data , eventmanager )
{
    GameObject.call( this , gamephysics , world , eventmanager );
    
    // 150x50 , the origo is at 135x25, 
    // shape is from 150x0 to 150x50 to 0x30 to 0x20
    this.radius = 25;
    this.graphics = PIXI.Sprite.fromImage("gfx/right-pedal.png");
    this.graphics.anchor.x = 0.5;
    this.graphics.anchor.y = 0.5;
    this.container.addChild( this.graphics );
    this.activationEvent = INPUT_PEDAL_RIGHT;
...
RightPedalObject.prototype = new GameObject();
RightPedalObject.prototype.constructor = RightPedalObject;

RightPedalObject.prototype.hitTest = function( point )
{
...
RightPedalObject.prototype.setTrigger = function( str )
{
    this.activationEvent = translateEventFromString( str );
};

RightPedalObject.prototype.getTrigger = function()
{
    return translateEventFromKey( this.activationEvent );
};

RightPedalObject.prototype.getName = function()
{
    return "right-pedal";
};

RightPedalObject.prototype.save = function()
{
    var object = { 
        type: this.getName(),
...
RightPedalObject.prototype.load = function( data )
{
    this.setPosition( data.position );
    this.setAngle( data.angle );
    this.setScale( data.scale );
...
RightPedalObject.prototype.activeState = function( state )
{
    this.physics.wakeUp();
...
RightPedalObject.prototype.gameEvent = function( event )
{
...
RightPedalObject.prototype.beginContactWith = function( another , x , y , nx , ny )
{
...
RightPedalObject.prototype.endContactWith = function( another )
{
    return true;
};
